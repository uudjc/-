...
"border-radius:8px;")
        ...
        self.pushButton_export = QtWidgets.QPushButton(FaceRecordForm)
        self.pushButton_export.setGeometry(QtCore.QRect(560, 40, 101, 31))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(10)
        font.setBold(True)
...
"}")
    ...
    def retranslateUi(self, FaceRecordForm):
        ...
        self.pushButton_export.setText(_translate("FaceRecordForm", "导出"))
import resource_rc
