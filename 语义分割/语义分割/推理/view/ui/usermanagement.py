...
class Ui_FaceRecordForm(object):
    def setupUi(self, FaceRecordForm):
        ...
        FaceRecordForm.resize(1100, 960)
...
"border-radius:8px;")
    ...
    def retranslateUi(self, FaceRecordForm):
        ...
        item.setText(_translate("FaceRecordForm", "账号"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("FaceRecordForm", "密码"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("FaceRecordForm", "角色"))
