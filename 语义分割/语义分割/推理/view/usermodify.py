...
class Ui_UserModifyDialog(object):
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_13.setText(_translate("Dialog", "角色:"))
        self.label_3.setText(_translate("Dialog", "账号:"))
        self.comboBox.setItemText(0, _translate("Dialog", "用户"))
        self.comboBox.setItemText(1, _translate("Dialog", "管理员"))
