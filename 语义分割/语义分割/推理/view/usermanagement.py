...
class Ui_UserManagement(object):
    def setupUi(self, UserManagementForm):
        UserManagementForm.setObjectName("UserManagementForm")
        UserManagementForm.resize(1100, 960)
        UserManagementForm.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.pushButton_search = QtWidgets.QPushButton(UserManagementForm)
...
"}")
        ...
        self.pushButton_modify = QtWidgets.QPushButton(UserManagementForm)
...
"}")
        ...
        self.tableWidget = QtWidgets.QTableWidget(UserManagementForm)
        self.tableWidget.setGeometry(QtCore.QRect(20, 90, 1100, 960))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.pushButton_delete = QtWidgets.QPushButton(UserManagementForm)
...
"}")
        ...
        self.lineEdit_search = QtWidgets.QLineEdit(UserManagementForm)
...
"border-radius:8px;")
        ...
        self.retranslateUi(UserManagementForm)
        QtCore.QMetaObject.connectSlotsByName(UserManagementForm)

    def retranslateUi(self, UserManagementForm):
        _translate = QtCore.QCoreApplication.translate
        UserManagementForm.setWindowTitle(_translate("UserManagementForm", "Form"))
        self.pushButton_search.setText(_translate("UserManagementForm", " 搜索"))
        self.pushButton_modify.setText(_translate("UserManagementForm", " 修改"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("UserManagementForm", "账号"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("UserManagementForm", "密码"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("UserManagementForm", "角色"))
        self.pushButton_delete.setText(_translate("UserManagementForm", " 删除"))
import resource_rc
