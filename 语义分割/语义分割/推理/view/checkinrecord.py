...
"border-radius:8px;")
        ...
        self.pushButton_export = QtWidgets.QPushButton(CheckInRecordForm)
        self.pushButton_export.setGeometry(QtCore.QRect(540, 40, 101, 31))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(10)
        font.setBold(True)
...
"}")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icon/pic/add.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, CheckInRecordForm):
        ...
        self.pushButton_export.setText(_translate("CheckInRecordForm", "导出"))
import resource_rc
